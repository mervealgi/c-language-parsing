...
static const yytype_uint8 yyrline[] =
{
      ...
      34,    35,    36,    36,    37,    45,    46,    47,    48,    49,
      50,    51,    52,    55,    61,    63,    63,    78,    78,    89,
      92,    93,    95,   102,   102
};
#endif
...
int main(int argc,char *argv[])
{
	...
	dosyayaz=fopen("g151210059_soru3.txt","w");	//YAZILACAK DOSYA
